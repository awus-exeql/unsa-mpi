...
Entonces $x \in A \land (x \in B\lor \in C)$.
Luego $(x \in A \land x \in B) \lor(x \in A \land x \in C)$
Entonces $x \in(A \cap B) \cup(A \cap C)$.

$\supset)$
Sea $x \in(A \cap B) \cup(A \cap C)$.
Entonces $(x \in A \land x \in B)\lor(x \in A \land x \in C)$.
Luego $x \in A \land (x \in B \lor x \in C)$.
